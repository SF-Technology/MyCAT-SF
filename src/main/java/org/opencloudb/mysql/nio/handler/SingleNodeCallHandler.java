 ...
 * @since 1.5.3
 */
public class SingleNodeCallHandler implements ResponseHandler, Terminatable {
    private static final Logger LOGGER = Logger.getLogger(SingleNodeCallHandler.class);
    ...
    public SingleNodeCallHandler(RouteResultset rrs, NonBlockingSession session) {
        this.rrs = rrs;
    ...
    private void backConnectionErr(ErrorPacket errPkg, BackendConnection conn) {
        ...
        LOGGER.warn("execute  sql err :" + errmgs + " con:" + conn + " frontend host:" + errHost
                + "/" + errPort + "/" + errUser);
    ...
    public String toString() {
        return "SingleNodeCallHandler [node=" + node + ", packetId=" + packetId + "]";
    }
